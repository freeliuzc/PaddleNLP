...
class EagleLlamaForCausalLMBlockInferenceModel(LlamaForCausalLMBlockInferenceModel):
    ...
    def set_state_dict(self, state_dict):
        ...
        self.eagle.fc.weight.set_value(
            paddle.to_tensor(state_dict["llama.fc.weight"]).cast(self.lm_head.weight.dtype)
        )
        self.eagle.fc.bias.set_value(
            paddle.to_tensor(state_dict["llama.fc.bias"]).cast(self.lm_head.weight.dtype)
        )
